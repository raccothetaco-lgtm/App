                      ...
                      <div className="space-y-2">
                        ...
                        {selectedPlayerId === player.id ? (
                          ...
                          <button
                            ...
                            className="w-full bg-neutral-700 hover:bg-neutral-600 text-neutral-200 rounded-lg px-4 py-2 flex items-center justify-center gap-2 transition-colors text-sm"
                          >
                        ...
                        <div className="pt-1 border-t border-neutral-700">
                          <label className="text-xs text-neutral-400 mb-1 block">Final Winnings:</label>
