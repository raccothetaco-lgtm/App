...
type GameState = 'playing' | 'ad' | 'redistribute' | 'settlement';
...
export default function App() {
  ...
  return (
    <div className="size-full bg-neutral-950 text-neutral-50 flex items-center justify-center p-4 overflow-auto">
        ...
        {showSplash ? (
          ...
          >
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-7xl font-bold tracking-tight bg-gradient-to-r from-emerald-400 to-emerald-600 bg-clip-text text-transparent"
            >
              Poker Pal
            </motion.h1>
            <motion.p
            ...
            >
              Track contributions and settle up
            </motion.p>
          </motion.div>
        ) : (
              ...
              <div className="bg-neutral-900 rounded-2xl p-4 sm:p-6 space-y-4">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-neutral-800 border border-neutral-700 rounded-lg px-4 py-3 text-sm sm:text-base text-neutral-50 placeholder:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                  />
                  <button
                    onClick={addPlayer}
                    className="bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg px-4 sm:px-5 py-3 flex items-center gap-2 transition-colors"
                  >
                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="text-neutral-500 hover:text-red-400 transition-colors text-xs whitespace-nowrap"
                          >
                            Remove
                          </button>
                        </div>
          ...
          {gameState === 'ad' && (
            <AdInterstitial onComplete={() => setGameState('redistribute')} />
          )}
          ...
          {gameState === 'redistribute' && (
            ...
            >
              ...
              <div className="bg-neutral-900 rounded-2xl p-4 sm:p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                {players.map((player) => (
                  <div
                    key={player.id}
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        placeholder="0.00"
                        step="0.01"
                        className="flex-1 min-w-0 bg-neutral-900 border border-neutral-700 rounded-lg px-4 py-2 text-sm sm:text-base text-neutral-50 placeholder:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                      />
                    </div>
                  </div>
                ))}
          ...
          {gameState === 'settlement' && (
            ...
            >
              ...
              <div className="bg-neutral-900 rounded-2xl p-4 sm:p-6 space-y-3 max-h-96 overflow-y-auto">
